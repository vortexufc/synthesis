...
func _abrir_interface() -> void:
	var script_ui = load("res://scripts/ui/quests_cientista.gd")
...
func _criar_balao_e_indicadores() -> void:
	...
	_balao_interacao.name = "BalaoInteracao"
	...
	sb.border_color = Color(0.2, 0.85, 0.5, 1.0) # Verde Cientista
...
func _atualizar_indicador_quest() -> void:
	...
	var q1_conc = PlayerStats.quests_concluidas.get("cientista_quest1", false)
	var q2_conc = PlayerStats.quests_concluidas.get("cientista_quest2", false)
	var q1_ativa = PlayerStats.quests_ativas.get("cientista_quest1", false)
	var q2_ativa = PlayerStats.quests_ativas.get("cientista_quest2", false)
